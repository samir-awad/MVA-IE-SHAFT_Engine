...
public class TC126_MakePaymentValidationsBP_PayWithNewCardAndSaveLater {
    ...
    @Test
    public void MakePaymentValidationsBP_PayWithNewCardAndSaveLater(){
        ...
        BillsPaymentsPage.pressPayWithNewCardAndSaveItForLaterButton();

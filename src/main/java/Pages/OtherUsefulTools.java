...
public class OtherUsefulTools {
    ...
    private static By WebtextPageHeader_Text;
    private static By WebtextHeaderClose_Button;
    private static By Recipients_Text;
    private static By WebTextInputMessage_Text;
    private static By Send_Button;
    private static By WebtextInternationalToast_Text;
    private static By WebtextInternationalConfirm_Button;
    private static By RemainingCharactersText;
    private static By Change_Button;
    private static By SelectTimeOption_Button;
    private static By Select_Button;
    private static By SetMessageSendTime_Title;
    private static By ChangeDate_Spinner;
    private static By SelectedNewDateSpinner_Item;
    private static By SendMessageNow_Text;
    private static By NacRequestPageHeader_Text;
    private static By FewThingsFirst_Title;
    private static By FewThingsFirstContent1_Title;
    private static By FewThingsUnlockedDescription_Text;
    private static By FewThingsFirstContent2_Title;
    private static By FewThingsElegibleDescriptionBillPay_Text;
    private static By FewThingsElegibleRule0_Text;
    private static By FewThingsElegibleBillPayRule0_Text;
    private static By FewThingsElegibleBillPayRule1_Text;
    private static By FewThingsElegibleBillPayRule2_Text;
    private static By FewThingsFirstContent2_Link;
    private static By NacFewThingsFirstContinue_Button;
    private static By RequestNAC_Title;
    private static By NACRequestContentCard_Title;
    private static By FewThingsFirstUnlocked_Title;
    private static By FewThingsFirstIMEI_Input;
    private static By NACRequest_Button;
    private static By NACRequestCancelFlow_Button;
    private static By InvalidIMEIMessage_Text;
    private static By AccessContactsPermissionAllow_button;
    private static By MessageBody;
